...
const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-blue-400 to-purple-500 py-8 flex flex-col px-5 lg:px-4 gap-6 lg:gap-0 lg:flex-row lg:justify-around items-center">
      ...
      <div className="text text-center lg:text-left lg:w-[40%] flex flex-col gap-4">
        ...
        <p className="text-white text-md md:text-lg">I am a hard worker and enthusiastic person, I want to build my
      ...
      <div className="img h-[300px] w-full md:w-[450px] md:h-[400px] overflow-hidden rounded-xl "></div>
